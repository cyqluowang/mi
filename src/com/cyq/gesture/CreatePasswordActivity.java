...
import com.cyq.view.LockPatternView.DisplayMode;

public class CreatePasswordActivity extends Activity implements
		OnClickListener {
	...
	private void saveChosenPatternAndFinish() {
		...
		showToast("密码设置成功");
		startActivity(new Intent(this,UnlockPasswordActivity.class));
		finish();
	}
}
